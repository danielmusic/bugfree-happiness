    ...
    <div class="container" style="margin-top: 80px;">
        ...
        <div id="main" class="release main-right main-medium">
            <article>
                ...
                <p style="font-size: 24px; color: rgb(234,66,51);">&quot;The funny thing is that none of our songs have turned out the way we imagined. Let's say I write some lyrics or have an idea. Once we jam it out it becomes something completely different, and that's one of the best things about being in a band.&quot;</p>
