                    ...
                    <div class="container" style="width: 50%;">
                        ...
                        <div class="row clearfix">
                            <div class="col-1-1">
                                ...
                                <input id="password" type="password" title="Password should contain at least 6 characters, including Upper/lowercase and numbers" name="password" required onchange="form.repassword.pattern = this.value;">
