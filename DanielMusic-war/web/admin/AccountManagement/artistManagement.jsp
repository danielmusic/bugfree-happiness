    ...
    <body onload="alertFunc()">
        ...
        <script>
            ...
            function deleteAccount(id) {
                artistManagement.id.value = id;
                artistManagement.target.value = "DeleteAccount";
                document.artistManagement.action = "../../AccountManagementController";
                document.artistManagement.submit();
            }
        </script>
                                        ...
                                        <%
                                            if (artists != null && artists.size() > 0) {
                                                for (int i = 0; i < artists.size(); i++) {
                                                    if (!artists.get(i).getIsBand() && !artists.get(i).getIsDeleted()) {
                                        %>
                                        <tr>        
                                            ...
                                            <td>
                                                ...
                                                <div class='btn-group'>
                                                    ...
                                                    <button type="button" class="modal-with-move-anim btn btn-default"  href="#modalRemove<%=artists.get(i).getId()%>">Disable</button>
                                                </div>
                                                <div id="modalRemove<%=artists.get(i).getId()%>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
                                                    <section class="panel">
                                                        <header class="panel-heading">
                                                ...
                                                <div class='btn-group'>
                                                    ...
                                                    <button type="button" class="modal-with-move-anim btn btn-default"  href="#modalDelete<%=artists.get(i).getId()%>">Delete</button>
                                                    <div id="modalDelete<%=artists.get(i).getId()%>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
                                                        <section class="panel">
                                                            <header class="panel-heading">
                                                                <h2 class="panel-title">Are you sure?</h2>
                                                            </header>
                                                            ...
                                                            <footer class="panel-footer">
                                                                <div class="row">
                                                                    <div class="col-md-12 text-right">
                                                                        <input class="btn btn-primary modal-confirm" name="btnRemove" type="submit" value="Confirm" onclick="deleteAccount(<%=artists.get(i).getId()%>)"  />
                                                                        <button class="btn btn-default modal-dismiss">Cancel</button>
                                                                    </div>
                                                                </div>
                                                            </footer>
