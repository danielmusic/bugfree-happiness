    ...
    <body onload="alertFunc()">
        ...
        <script>
            ...
            function deleteAccount(id) {
                bandManagement.id.value = id;
                bandManagement.target.value = "DeleteAccount";
                document.bandManagement.action = "../../AccountManagementController";
                document.bandManagement.submit();
            }
        </script>
                                        ...
                                        <%
                                            if (bands != null && bands.size() > 0) {
                                                for (int i = 0; i < bands.size(); i++) {
                                                    if (bands.get(i).getIsBand() && !bands.get(i).getIsDeleted()) {
                                        %>
                                        <tr>        
                                            ...
                                            <td>
                                                ...
                                                <div class='btn-group'>
                                                    ...
                                                    <button type="button" class="modal-with-move-anim btn btn-default"  href="#modalDelete<%=bands.get(i).getId()%>">Delete</button>
                                                    <div id="modalDelete<%=bands.get(i).getId()%>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
                                                        <section class="panel">
                                                            <header class="panel-heading">
                                                                <h2 class="panel-title">Are you sure?</h2>
                                                            </header>
                                                            ...
                                                            <footer class="panel-footer">
                                                                <div class="row">
                                                                    <div class="col-md-12 text-right">
                                                                        <input class="btn btn-primary modal-confirm" name="btnRemove" type="submit" value="Confirm" onclick="deleteAccount(<%=bands.get(i).getId()%>)"  />
                                                                        <button class="btn btn-default modal-dismiss">Cancel</button>
                                                                    </div>
                                                                </div>
                                                            </footer>
