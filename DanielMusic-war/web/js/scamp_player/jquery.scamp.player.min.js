...
(function (a) {
    a.ScampPlayer = function (b, c) {
            ...
            if (window.soundManager) {
                sm_obj = {onready: function () {
                        ...
                        if (d.settings.mobile && d.settings.path != null) {
                            ...
                            var v = soundManager.createSound({id: "init_mobile_track", url: d.settings.path + "/blank.mp3", autoload: false, volume: 10, onload: function () {
                                }, onplay: function () {
                                }, onpause: function () {
                                }, onresume: function () {
                                }, onstop: function () {
                        ...
                        if (w !== null) {
                            d.settings.obj = {status: "working", action: "add_tracks", tracks: w, tracks_size: x, track_nr: -1, };
                            s();
                        }
        ...
        var g = function () {
            ...
            d.settings.sound = soundManager.createSound({id: "scamp_sound", url: u, autoload: false, volume: d.settings.volume, onload: function () {
                }, onplay: function () {
                    var v = {title: d.settings.track.find(".sp-title-button").text(), url: d.settings.track.find(".sp-track-control").attr("href"), artist: d.settings.track.find(".sp-artist-button").text(), track_index: _get_track_index(), tracklist_length: d.settings.tracklist_length};
        ...
        var r = function () {
            ...
            var x = _get_track_index(), u = null, w = null;
        ...
        var f = function () {
            ...
            var x = _get_track_index(), v = x + 1, u = null, w = false;
        ...
        var e = function () {
            ...
            var x = _get_track_index(), w = x - 1, u = null, v = false;
            if (d.el.hasClass("playing")) {
                d.settings.track.removeClass("playing");
                d.el.removeClass("playing");
                v = true;
        ...
        var t = function () {
            ...
            if (d.settings.sound) {
                var A = d.settings.track.find(".sp-cover-artwork img").attr("src"), B = d.settings.track.find(".sp-title-button").text(), w = d.settings.track.find(".sp-artist-button").text(), y = d.settings.track.find(".sp-artist-button").attr("href"), v = d.settings.track.find(".sp-artist-button").attr("target"), u = d.settings.track.find(".sp-title-button").attr("href"), z = d.settings.track.find(".sp-title-button").attr("target");
        ...
        var h = function () {
            ...
            if (d.settings.obj.action == "play_track" || d.settings.obj.action == "play_tracks") {
                for (var x = 0;
                        x < d.settings.obj.tracks_size; x++) {
        ...
        var q = function () {
            var w = d.settings.obj.track_nr, v = d.settings.obj.tracks[w].attr("href"), u = /http(s?):\/\/soundcloud/;
            if (u.test(v)) {
        ...
        _add_soundcloud = function () {
            var w = d.settings.obj.track_nr, u = d.settings.obj.tracks[w].attr("href");
            ...
            if (d.settings.obj.tracks[w].data("sc_stream") != undefined) {
                var v = {stream_url: null, artwork_url: null, title: null, permalink_url: null, user: {username: null, permalink_url: null}};
            ...
            SC.get("/resolve", {url: u}, function (x) {
        ...
        var n = function (x) {
            x.preventDefault();
            var y = a(this).parents('tr[class*="sp-track"]'), B = a(this).parents('tr[class*="sp-track"]').index(), z = null, A = false;
        ...
        var k = function () {
            var u = "ontouchstart" in window, x = u ? "touchstart" : "mousedown", y = u ? "touchmove" : "mousemove", v = u ? "touchend" : "mouseup", w = u ? "touchcancel" : "mouseup";
            a(".sp-volume-slider").on(x, function (F) {
                if (d.settings.tracklist_length == null) {
                    return;
                }
                var C = a(this), z = C.find(".sp-volume-position"), E = C.offset().left, B = C.width(), D = d.settings.sound, A = null;
                a(document).on(y, function (I) {
                    ...
                    a(this).unbind(v);
                    return false;
                }).trigger({type: y, clientX: F.clientX});
                return false;
            });
            a(".sp-progress").bind(x, function (E) {
                ...
                var A = a(this).addClass("searching"), z = A.find(".sp-postion"), D = A.offset().left, B = A.width(), C = d.settings.sound;
                ...
                a(document).bind(y, function (H) {
                    ...
                    a(this).unbind(v);
                    return false;
                }).trigger({type: y, clientX: E.clientX});
                return false;
            });
        };
        ...
        _format_time = function (v) {
            var x = Math.floor(v / 1000), u = Math.floor(x / 60), w = x - u * 60;
            return u + ":" + (w < 10 ? "0" + w : w);
        };
        _pretty_link = function (z) {
            var E = "", B = "", u = z.attr("href"), F = z.data("cover"), w = z.data("artist"), D = z.data("artist_url"), C = z.data("artist_target"), A = z.data("release_url"), y = z.data("release_target"), v = z.data("shop_url"), x = z.data("shop_target");
        ...
        _add_track = function (w) {
            ...
            var u = _pretty_link(a(this)), v = [u];
            d.settings.obj = {status: "working", action: "add_track", tracks: v, tracks_size: 1, track_nr: -1};
            s();
            return false;
        };
        _play_track = function (w) {
            ...
            d.settings.obj = {status: "working", action: "play_track", tracks: v, tracks_size: 1, track_nr: -1};
            s();
            return false;
        };
        _add_tracks = function (v) {
            ...
            var x = a("#" + y), u = new Array(), w = a("a.sp-add-track, a.sp-play-track", x).length;
            a("a.sp-add-track, a.sp-play-track", x).each(function (z) {
                u.push(_pretty_link(a(this)));
            });
            d.settings.obj = {status: "working", action: "add_tracks", tracks: u, tracks_size: w, track_nr: -1};
            s();
        };
        _play_tracks = function (v) {
            ...
            var x = a("#" + z), u = new Array(), w = a("a.sp-add-track, a.sp-play-track", x).length;
            ...
            d.settings.obj = {status: "working", action: "play_tracks", tracks: u, tracks_size: w, track_nr: -1};
            s();
        };
        _debug = function (u) {
            if (d.settings.debug) {
        ...
        d.addTrack = function (u, w) {
            ...
            d.settings.obj = {status: "working", action: w, tracks: v, tracks_size: 1, track_nr: -1};
            s();
            return false;
        };
        d.addTracks = function (x, A) {
            ...
            d.settings.obj = {status: "working", action: A, tracks: u, tracks_size: z, track_nr: -1};
            s();
        };
