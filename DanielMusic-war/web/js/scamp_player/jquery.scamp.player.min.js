...
(B.indexOf("secret_token")==-1)?B=B+"?":B=B+"&";B=B+"consumer_key="+d.settings.client_id;if(u==undefined||u==""){u=v.user.username;}if(A==undefined||A==""){A=v.user.permalink_url;
}if(z==undefined||z==""){z="_blank";}if(y==undefined||y==""){y=v.permalink_url;}if(w==undefined||w==""){w="_blank";}d.settings.obj.tracks[x].attr("data-sc",t);
d.settings.obj.tracks[x].attr("href",B);d.settings.obj.tracks[x].attr("data-cover",v.artwork_url);d.settings.obj.tracks[x].attr("data-artist",u);d.settings.obj.tracks[x].attr("data-artist_url",A);
