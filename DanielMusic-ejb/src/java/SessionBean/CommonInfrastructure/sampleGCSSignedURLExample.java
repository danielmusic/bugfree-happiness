...
public class sampleGCSSignedURLExample {

    final String SERVICE_ACCOUNT_EMAIL = "905886242502-8jv7f7qopknh74kmjb1ka4vdnrvk6no1@developer.gserviceaccount.com";
    final String SERVICE_ACCOUNT_PKCS12_FILE_PATH = "S:\\DanielMusic\\DanielMusic-ejb\\src\\java\\Credentials\\DanielMusic-1536a289ea67.p12";
    final long expiration = System.currentTimeMillis()/1000 + 60;

    final String BUCKET_NAME = "danielmusictest";
    String OBJECT_NAME = "output.mp3";

    PrivateKey key;

    public static void main(String[] args) {
        sampleGCSSignedURLExample tc = new sampleGCSSignedURLExample();
    }

    public sampleGCSSignedURLExample() {
        try {
...
//          Return actual file (don't uncomment unless printing out text)
//             renderResponse(httpCon.getInputStream());
