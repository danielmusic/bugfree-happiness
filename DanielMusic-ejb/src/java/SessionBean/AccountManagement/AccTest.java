 ...
 * @author -VeRyLuNaTiC
 */
@WebService(serviceName = "AccTest")
@Stateless()
public class AccTest {
    ...
    @WebMethod(operationName = "updateAccountProfile")
    public ReturnHelper updateAccountProfile(@WebParam(name = "accountID") Long accountID, @WebParam(name = "newName") String newName, @WebParam(name = "profilePicture") Part profilePicture, @WebParam(name = "description") String description) {
        return ejbRef.updateAccountProfile(accountID, newName, profilePicture, description);
    }
